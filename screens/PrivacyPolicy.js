  ...
  return (
    ...
    >
      ...
      <ScrollView>
        ...
        >
          Privacy Policy ============== Last updated: March 07, 2023 This
          ...
          plural. Definitions ----------- For the purposes of this Privacy
          ...
          directors or other managing authority. * Application refers to Dest,
          the software program provided by the Company. * Company (referred to
          as either "the Company", "We", "Us" or "Our" in this Agreement) refers
          to Dest. * Country refers to: Kuwait * Device means any device that
          ...
          in or create an account to use the Service. * Usage Data refers to
          ...
          to: * Email address * First name and last name * Usage Data Usage Data
          ...
          following Third-party Social Media Services: * Google * Facebook *
          Twitter * LinkedIn If You decide to register through or otherwise
          ...
          activities or Your contact list associated with that account. You may
          ...
          Policy. Information Collected while Using the Application
          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ While using Our
          ...
          through Your Device settings. Use of Your Personal Data
          ...
          for their implementation. * To provide You with news, special offers
          ...
          * To manage Your requests: To attend and manage Your requests to Us. *
          ...
          of Our business to another company. * With Affiliates: We may share
          ...
          profile. * With Your consent : We may disclose Your personal
          information for any other purpose with Your consent. Retention of Your
          Personal Data ------------------------------- The Company will retain
          Your Personal Data only for as long as is necessary for the purposes
          set out in this Privacy Policy. We will retain and use Your Personal
          ...
          Delete Your Personal Data ------------------------- You have the right
          to delete or request that We assist in deleting the Personal Data that
          We have collected about You. Our Service may give You the ability to
          delete certain information about You from within the Service. You may
          update, amend, or delete Your information at any time by signing in to
          ...
          government agency). Other legal requirements ~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          consent, We take steps to remove that information from Our servers. If
          We need to rely on consent as a legal basis for processing Your
          information and Your country requires consent from a parent, We may
          require Your parent's consent before We collect and use that
          information. Links to Other Websites ======================= Our
          ...
          third party sites or services. Changes to this Privacy Policy
          ...
          effective when they are posted on this page. Contact Us ========== If
          you have any questions about this Privacy Policy, You can contact us:
          * By email: dest.kuwait@gmail.com * By phone number: +96597947057
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
