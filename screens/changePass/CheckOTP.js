                    ...
                    <View>
                        {sent === false ? (
                            <TouchableOpacity onPress={handleOTP}>
                                <Text style={{color: "#9279f7", marginTop: -206, alignSelf: "center", fontSize: 19 }}>Resend OTP?</Text>
                            </TouchableOpacity>
                        ) : (
                            <>
                                <Text style={{color: "#9279f7", marginTop: -206, alignSelf: "center", textAlign: "center", fontSize: 19 }}>After 6 minutes you can request a new OTP</Text>
                                {setTimeout}
                            </>
                        )}
                    </View>
